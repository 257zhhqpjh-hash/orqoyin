...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const T = {
        uz: {
            ...
            hero_badge:         "Urganchning yagona kiberxavfsizlik markazi",
            hero_line1:         "KELAJAK",
            hero_line2:         "HIMOYA",
            hero_line3:         "QILINGAN",
            hero_sub:           "Kiberxavfsizlik va ingliz tili — ikki kuchni birlashtirib, dunyo darajasidagi mutaxassis bo'ling.",
            hero_btn_courses:   "Kurslarni ko'rish",
            hero_btn_about:     "Biz haqimizda",
            stat_directions:    "Yo'nalish",
            stat_free:          "Bepul kurs",
            stat_unique:        "Mintaqada yagona",
            scroll_down:        "Pastga",
            courses_title:      "Ikki kuch.\nCheksiz imkoniyat.",
            cyber_tag:          "KIBERXAVFSIZLIK",
            cyber_title:        "Kiberxavfsizlik",
            cyber_desc:         "Tarmoqlarni himoya qilishdan tizimga kirib tekshirishgacha — raqamli dunyoning muhandisi bo'ling.",
            ...
            eng_desc:           "Noldan boshlab — grammatika, lug'at va to'rt asosiy ko'nikma. Ikkita variant: kattalar va bolalar.",
            ...
            eng_play:           "O'yin orqali o'rgatish",
            ...
            why_title:          "Nega",
            why_desc:           "Urganchda birinchi va yagona ixtisoslashgan kiberxavfsizlik markazi. Biz faqat ikkita soha o'rgatamiz — lekin ularni eng yuqori darajada.",
            reason1_title:      "Mintaqada yagona",
            reason1_desc:       "Urganchda kiberxavfsizlik bo'yicha birinchi ixtisoslashgan markaz.",
            reason2_title:      "Ikki kursni bir joyda",
            reason2_desc:       "Kiberxavfsizlik + ingliz tili — texnik va muloqot ko'nikmalarini bir joyda rivojlantiring.",
            reason3_title:      "100% amaliy",
            reason3_desc:       "Haqiqiy laboratoriyalar, real vaziyatlar, aniq natijalar.",
            reason4_title:      "Ilm bilan to'yintirish",
            reason4_desc:       "Faqat sertifikat emas — chuqur bilim va mustaqil fikrlash.",
            amen_hours:         "Dush–Payshanba rasmiy ish kunlari. Juma, shanba, yakshanba — to'garaklar va erkin faoliyat.",
            ...
            cta_sub:            "Kelajagingizni bugun boshlang",
            cta_title:          "Tayyormisiz?",
            cta_register:       "Ro'yxatdan o'ting →",
            cta_or:             "yoki",
            contact_label:      "RO'YXAT",
            contact_title:      "Qo'shiling.",
            contact_desc:       "Bepul maslahat uchun ma'lumotlaringizni qoldiring. 24 soat ichida aloqaga chiqamiz.",
            ...
            map_desc:           "Urganch — mintaqaning yagona kiberxavfsizlik markazi.",
            map_btn:            "Google Xaritada ochish",
            clubs_label:        "BEPUL TO'GARAKLAR",
            clubs_title_pre:    "Hafta oxiri",
            clubs_title_free:   "bepul.",
            clubs_desc:         "Juma, shanba va yakshanba kunlari rasmiy darslar bo'lmaydi — bu kunlar to'garaklar, tarmoq qurilishi va hamkasblar bilan bilim almashinuvi uchun. Ro'yxatdan o'tish kerak — ammo onlayn emas. Markazga kelib, shaxsan yozilasiz. To'lov yo'q.",
            footer_tagline:     "Urganchning yagona kiberxavfsizlik markazi",
            footer_rights:      "Barcha huquqlar himoyalangan.",
            garaoy_desc:        "Bizning yangi platformamiz — Linux, Android va macOS uchun",
            coming_soon:        "Tez orada",
            toast_success:      "Muvaffaqiyatli! Tez orada aloqaga chiqamiz.",
        },
        tm: {
            nav_register:       "Hasaba durmak",
            nav_courses:        "Kurslar",
            nav_about:          "Biz hakda",
            hero_badge:         "Örgeniçiň ýeke-täk kiberhowpsuzlyk merkezi",
            hero_line1:         "GELJEK",
            hero_line2:         "GORAGLY",
            hero_line3:         "BOLSUN",
            hero_sub:           "Kiberhowpsuzlyk we iňlis dili — iki güýji birleşdirip, dünýä derejesindäki hünärmen boluň.",
            hero_btn_courses:   "Kurslary görmek",
            hero_btn_about:     "Biz hakda",
            stat_directions:    "Ugur",
            stat_free:          "Mugt kurs",
            stat_unique:        "Sebitde ýeke-täk",
            scroll_down:        "Aşak",
            courses_title:      "Iki güýç.\nçäksiz mümkinçilik.",
            cyber_tag:          "KIBERHOWPSUZLYK",
            cyber_title:        "Kiberhowpsuzlyk",
            cyber_desc:         "Ulgamlary goramakdan ulgama aralaşmaga çenli — sanly dünýäniň inženeri boluň.",
            ...
            eng_desc:           "Noldan başlap — grammatika, söz baýlygy we dört esasy endik. Iki görnüş: ululara we çagalara.",
            ...
            free_join:          "Goşulmak",
            why_title:          "Näme üçin",
            why_desc:           "Örgeniçde ilkinji we ýeke-täk ýöriteleşdirilen kiberhowpsuzlyk merkezi. Biz diňe iki ugry öwredýäris — ýöne olary iň ýokary derejede.",
            reason1_title:      "Sebitde ýeke-täk",
            reason1_desc:       "Örgeniçde kiberhowpsuzlyk boýunça ilkinji ýöriteleşdirilen merkez.",
            reason2_title:      "Iki kursy bir ýerde",
            reason2_desc:       "Kiberhowpsuzlyk + iňlis dili — tehniki we aragatnaşyk endiklerini bir ýerde ösdüriň.",
            reason3_title:      "100% amaly",
            reason3_desc:       "Hakyky laboratoriýalar, real ýagdaýlar, anyk netijeler.",
            reason4_title:      "Bilim bilen doýmak",
            reason4_desc:       "Diňe şahadatnama däl — çuňňur bilim we garaşsyz pikir.",
            amen_hours:         "Duş–Penş resmi iş günleri. Anna, şenbe, ýekşenbe — toparlar we erkin çäre.",
            ...
            cta_sub:            "Geljegňizi şu gün başlaň",
            ...
            map_desc:           "Örgeniç — sebitiň ýeke-täk kiberhowpsuzlyk merkezi.",
            map_btn:            "Google Kartada açmak",
            clubs_label:        "MUGT TOPARLAR",
            clubs_title_pre:    "Hepde soňy",
            clubs_title_free:   "mugt.",
            clubs_desc:         "Anna, şenbe we ýekşenbe günleri resmi sapaklar ýok — bu günler toparlar, ulgam gurmak we bilim paýlaşmak üçin. Hasaba almak gerek — ýöne onlaýn däl. Merkeze gelip, şahsy ýazylaýarsyňyz. Töleg ýok.",
            footer_tagline:     "Örgeniçiň ýeke-täk kiberhowpsuzlyk merkezi",
            footer_rights:      "Ähli hukuklar goralýar.",
            garaoy_desc:        "Biziň täze platformamyz — Linux, Android we macOS üçin",
            coming_soon:        "Ýakynda",
